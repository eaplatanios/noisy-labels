...
__all__ = ["extract_bert_features", "extract_glove_features", "WordSimLoader"]
...
class WordSimLoader(object):
  ...
  """
    ...
    def load(data_dir, load_features=True):
        ...
        # Extract annotations.
        annotations = df.drop_duplicates(subset=["orig_id", "!amt_worker_ids"]).pivot(
            index="orig_id", columns="!amt_worker_ids", values="response"
        )
